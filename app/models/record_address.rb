class RecordAddress
  ...
  def save
    ...
    # addressesの情報を保存
    Address.create!(postal_code: postal_code, prefecture_id: prefecture_id, municipality: municipality, address: address, building: building, tel: tel, record_id: record.id)
  end
